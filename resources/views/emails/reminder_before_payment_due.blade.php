...
<head>
    ...
    <title>Upcoming Payment Reminder - {{ $companyName }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Upcoming Payment Reminder - {{ $serviceName }}</h1>
        <p>Dear {{ $clientName }},</p>
        <p>This is a friendly reminder that your payment for the service "{{ $serviceName }}" is due in 3 days ({{ $dueDate }}).</p>
        <p>Please ensure that the payment is made by the due date to avoid any disruption in your service.</p>
        <p>If you have any questions or need assistance, please contact our support team at <a href="mailto:contact@rydagency.com" style="color: #d3ac47;">contact@rydagency.com</a>.</p>
        <div class="footer">
