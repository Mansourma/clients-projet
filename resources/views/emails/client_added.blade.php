...
@elseif ($clientType === 'society')
    <p>Dear {{ $legalRepresentativeName }},</p>
@endif
        <p>We are delighted to welcome you to {{ $companyName }}. Thank you for choosing our services. We look forward to a productive and successful partnership.</p>
        <p>Our team is committed to providing you with exceptional support and assistance. Should you have any questions or require further information, please don't hesitate to reach out to us.</p>
        <p>To learn more about our services and how we can help you achieve your goals, please visit our website:</p>
        <p style="text-align: center;">
            <a href="https://rydagency.com" class="btn">Visit Our Website</a>
        </p>
        <div class="footer">
