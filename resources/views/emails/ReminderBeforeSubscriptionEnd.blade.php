...
<head>
    ...
    <title>Final Payment Reminder - {{ $companyName }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Final Payment Reminder - {{ $serviceName }}</h1>
        <p>Dear {{ $clientName }},</p>

        <p>This is a formal reminder that your subscription for the service "{{ $serviceName }}" will expire in 3 days on {{ $dueDate }}.</p>
        <p>Please be advised that failure to make the necessary payment by the due date will result in the immediate suspension of all services related to this subscription.</p>
        <p>We urge you to address this matter promptly to avoid any disruption in service. If payment has already been made, please disregard this notice. Should you require any assistance, our support team is available to help.</p>
        <p>Please note that continued non-payment may result in further actions, including the potential for additional fees or legal measures.</p>
